      ...
      <div className="container mx-auto">
        <div className=" flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen  ">
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.3}}  className=" flex-1 ">
            ...
            <p className=" mb-6 ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam dolorem impedit vero odit perferendis corrupti similique modi placeat laboriosam numquam!</p>
            <div className="flex gap-x-6 lg:gap-x-10 mb-12  ">
              ...
              <div className="">
                <div className=" text-[40px] font-tertiary text-gradient mb-2  ">
                  {
                    inView ?
                    <CountUp start={0} end={16} duration={3} /> : null }k+
                </div>
                <div className=" font-primary text-sm tracking-[2px]  ">
                  Projects <br />
                  Completed</div>
