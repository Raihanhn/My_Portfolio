        ...
        <div className=" flex flex-col lg:flex-row gap-x-10  ">
          <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.3}}  className=" flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0   ">
            <div className="">
              ...
              <p className='max-w-sm mb-16 ' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque sunt nam nesciunt neque quam eius labore odio veniam dolorem porro.</p>
